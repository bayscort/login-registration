...
/**
 * The {@link UnicodeBOMUtil} class wraps any
 ...
 */
public class UnicodeBOMUtil extends InputStream {
    ...
    /**
     * Constructs a new {@link UnicodeBOMUtil} that wraps the
     ...
     */
    public UnicodeBOMUtil(final InputStream inputStream) throws IOException {
        processUnicodeBOM(inputStream);
    }
     ...
     * specified {@link InputStream}.
     *
     * @param bytes an bytes.
     * @throws IOException on reading from the specified {@link InputStream}
     *                     when trying to detect the Unicode BOM.
     */
    public UnicodeBOMUtil(final byte[] bytes) throws IOException {
        InputStream inputStream = new ByteArrayInputStream(bytes);
        processUnicodeBOM(inputStream);
    }

    private void processUnicodeBOM(final InputStream inputStream) throws IOException {
     ...
     * {@link InputStream} object.
     *
     * @return this {@link UnicodeBOMUtil}.
     * @throws IOException when trying to skip the BOM from the wrapped {@link InputStream} object.
     */
    public final synchronized UnicodeBOMUtil skipBOM() throws IOException {
        if (!skipped) {
